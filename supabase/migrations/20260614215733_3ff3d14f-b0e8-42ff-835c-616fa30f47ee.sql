...
CREATE POLICY "Anyone inserts leads" ON public.leads
  FOR INSERT TO anon, authenticated WITH CHECK (true);
CREATE POLICY "Admins read leads" ON public.leads
  FOR SELECT TO authenticated USING (public.has_role(auth.uid(), 'admin'));

-- Visits (raw, used by existing /api/public/track endpoint)
...
CREATE POLICY "Anyone inserts visits" ON public.visits
  FOR INSERT TO anon, authenticated WITH CHECK (true);
...
CREATE POLICY "Anyone inserts payments" ON public.payments
  FOR INSERT TO anon, authenticated WITH CHECK (true);
...
CREATE POLICY "Anyone inserts visitors" ON public.visitors
  FOR INSERT TO anon, authenticated WITH CHECK (true);
CREATE POLICY "Anyone updates visitors" ON public.visitors
...
CREATE POLICY "Anyone inserts page_views" ON public.page_views
  FOR INSERT TO anon, authenticated WITH CHECK (true);
