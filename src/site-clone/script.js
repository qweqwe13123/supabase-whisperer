(function () {
  ...
  var I18N = {
    ...
    es: {
      ...
      plan249_features: [
        "Reescritura completa al estilo americano",
        "Optimización de estructura y contenido (ATS)",
        "Ayuda con perfil de LinkedIn",
        "Guía de preparación para entrevistas",
        "Asesoría personalizada de búsqueda de empleo"
      ],
      ...
      plan549_features: [
        ...
        "Consultoría personal por video",
        "Estrategia individual de búsqueda de empleo",
        "Preparación práctica de entrevistas",
        "Múltiples rondas de revisión del currículum",
        "Soporte prioritario"
      ],
