...
export const Route = createFileRoute("/es/contact")({
  head: () => ({
    meta: [
      { title: "Contacto — Trabajo Listo" },
      { name: "description", content: "Escríbenos por WhatsApp. Respondemos rápido." },
      { property: "og:title", content: "Contacto — Trabajo Listo" },
      { property: "og:description", content: "Escríbenos por WhatsApp. Respondemos rápido." },
    ],
  }),
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-neutral-50 to-sky-50 font-sans antialiased">
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-zinc-200/60">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link to="/es" className="text-sm font-medium text-zinc-600 hover:text-zinc-900">← Volver al inicio</Link>
        </div>
      </nav>
      ...
      <main className="max-w-3xl mx-auto px-6 py-20 md:py-28">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-white ring-1 ring-emerald-200 rounded-full px-4 py-1.5 text-xs font-semibold text-emerald-700 mb-6 shadow-sm">
            ...
            En línea ahora · Respondemos en minutos
          </div>
          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight leading-tight mb-4">
            Hablemos por <span className="text-emerald-600">WhatsApp</span>
          </h1>
          <p className="text-lg text-zinc-600 max-w-xl mx-auto">
            ¿Tienes preguntas sobre tu currículum, nuestro proceso o precios? Escríbenos — estamos aquí para ayudarte.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl ring-1 ring-zinc-200 shadow-2xl shadow-emerald-500/10 p-8 md:p-12">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="text-xs font-bold uppercase tracking-widest text-zinc-400 mb-2">Nuestro WhatsApp</div>
            ...
            <div className="mt-10 pt-8 border-t border-zinc-100 w-full grid sm:grid-cols-3 gap-6 text-sm">
              <div>
                <div className="text-zinc-400 text-xs font-semibold uppercase tracking-wider mb-1">Tiempo de respuesta</div>
                <div className="font-semibold text-zinc-900">En minutos</div>
              </div>
              <div>
                <div className="text-zinc-400 text-xs font-semibold uppercase tracking-wider mb-1">Idiomas</div>
                <div className="font-semibold text-zinc-900">Español · English</div>
              </div>
              <div>
                <div className="text-zinc-400 text-xs font-semibold uppercase tracking-wider mb-1">Horario</div>
                <div className="font-semibold text-zinc-900">Lun–Sáb, 9am–9pm PT</div>
              </div>
            </div>
          </div>
        </div>
